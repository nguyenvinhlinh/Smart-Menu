...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { category: @menu_item.category, description: @menu_item.description, ingredient: @menu_item.ingredient, name: @menu_item.name, taste: @menu_item.taste }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { category: @menu_item.category, description: @menu_item.description, ingredient: @menu_item.ingredient, name: @menu_item.name, taste: @menu_item.taste }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
